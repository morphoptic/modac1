# MODAC keywords
# common file to hold data name keys and convert them to topics and labeled JSON data,
# also ties to GUI builder etc
# generally this has become akin to c #define stuff for magic words
...
# topic keys for pyNNG messages
# topics from Server to clients
...
####
# keys for intraClient messages
def keyForTimeout(): return "Timeout"
def keyForPyNNG(): return "pyNNG_Exception"
def keyForTrioCancel(): return "Trio_Cancelled"
def keyForException(): return "Exception"
