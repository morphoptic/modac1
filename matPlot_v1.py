...
Mod isdale 1: use BME280 real time plot
* changes to source of data = moBME280
* changes to treeView: data now in columns vs rows, dbl click column to show it
* real time updates
"""
