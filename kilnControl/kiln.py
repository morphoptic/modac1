...
#
# TODO:  why do ktemps lag the kType reports in full update message - because readPublish is on slow update
# TODO (cont) while kiln is on faster? split data update() from publish() threads
